...
/***/ "./platform/plugin-interest/src/resources/js/plugininterest.js":
/*!*********************************************************************!*\
  !*** ./platform/plugin-interest/src/resources/js/plugininterest.js ***!
  \*********************************************************************/
...
$(document).ready(function () {
  function printOptionBank() {
    for (var i = 0; i < Object.keys(coefInterets).length; i++) {
      $('#select-bank').append('<option value="' + Object.keys(coefInterets)[i] + '">' + Object.keys(coefInterets)[i].replaceAll('-', ' ') + '</option>');
    }
  }
const coefInterets = {
	'Tuỳ-chọn': '',
  ...
  $('.root-money').keyup(function () {
    var rate = Number($('.rate-loan').val()) / 100;
    var money = $('.root-money').val().split(',').join('');
    ...
    if (money != 0) processInterest();
  });
  $('.rate-loan').keyup(function () {
    var rate = $('.rate-loan').val();
  ...
  $('.number-loan').keyup(function () {
    var moneyRoot = Number($('.root-money').val().split(',').join(''));
    var money = $(this).val().split(',').join('');
    money = Number(validateInputMoney(money));
    moneyLoan = money;
    var rate = money / moneyRoot * 100;
    $('.rate-loan').val(rate);
    money = formatMoney(money);
    $(this).val(money);
    processInterest();
  ...
  function payEqually(money, month, interest) {
    ...
    var html = '';
    var stt = 0;
    var payableCapital = money / month;
    var moneyFirstMonth;
    var sum = 0;
    var moneyInterest = money * interest;
    ...
    for (var i = month; i > 0; i--) {
      ...
      html += ' <tr>' + '                    <td scope="row" class="text-center">' + stt + '</td>' + '                    <td>' + formatMoney(Number(money).toFixed()) + '</td>' + '                    <td>' + formatMoney(Number(payableCapital).toFixed()) + '</td>' + '                    <td>' + formatMoney(Number(moneyInterest).toFixed()) + '</td>' + '                    <td>' + formatMoney(Number(sum).toFixed()) + '</td>' + '                </tr>';
  ...
  function setValueViewResult(money, payFirstMonth) {
    var rootMoney = Number($('.root-money').val().split(',').join(''));
    var moneyCurrent = rootMoney - moneyLoan;
    var moneyMust = moneyLoan;
    ...
    var total = moneyCurrent + moneyMust + money;
    var rate = $('.rate-loan').val();
  ...
  function html_table_to_excel(type) {
    var data = document.getElementById('tb-export');
    ...
    XLSX.writeFile(file, 'tienlai.' + type);
  }

  var export_button = document.getElementById('btn-export-excel');
...
/***/ "./platform/plugin-interest/src/resources/scss/plugininterest.scss":
/*!*************************************************************************!*\
  !*** ./platform/plugin-interest/src/resources/scss/plugininterest.scss ***!
  \*************************************************************************/
...
/******/ 	__webpack_require__.O(undefined, ["css/plugininterest"], () => (__webpack_require__("./platform/plugin-interest/src/resources/js/plugininterest.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/plugininterest"], () => (__webpack_require__("./platform/plugin-interest/src/resources/scss/plugininterest.scss")))
